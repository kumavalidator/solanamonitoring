...
##### optional:        #
identityPubkey="3tm92VTxwyZ5MDhGoYR4tVTkwWYkzfam6hwBjauUACCk"      # identity pubkey for the validator, insert if autodiscovery fails
voteAccount="4m1PbxzwLdUnEwog3T9UKxgjktgriHgE1CfAhMqDw7Xx"         # vote account address for the validator, specify if there are more than one or if autodiscovery fails
...
rpcURL="https://api.mainnet-beta.solana.com"              # default is localhost with port number autodiscovered, alternatively it can be specified like http://custom.rpc.com:port
